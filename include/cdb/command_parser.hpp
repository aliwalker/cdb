...
public:
    ...
    */
    ...
    /// Encoders for GET/SET/DEL commands.
    static std::string encode_get(std::string const &key);
    static std::string encode_set(std::string const &key, std::string const &value);
    static std::string encode_del(std::string const &key);
    static std::string encode_del(std::vector<std::string> const &keys);
